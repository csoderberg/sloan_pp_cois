---
title: "views_downloads_collection"
...
views_df = pd.DataFrame(columns=['guid', 'sloan_id', 'coi_shown', 'date', 'view_count'])
empty_lists = 0
calls = 1
    ...
    if len(pp_views_byuser) > 0: # only parse query output if there were actually views/downloads to parse
      ...
      for x in range(len(pp_views_byuser)):
        ...
        for j in range(len(user_actions['buckets'])):
          ...
          sloan_coi_cond = user_actions['buckets'][j]['key_as_string']
          ...
          for k in range(len(user_views)):
            ...
            new_row = [{'guid':guid,'sloan_id':pp_views_byuser[x]['key'],'coi_shown':sloan_coi_cond,'date':user_views[k]['key_as_string'],'view_count': user_views[k]['doc_count']}]
...
view_for_minute_pulls <- views_by_hour_results %>%
                          ...
                          filter(view_count > 0) %>%
                          group_by(guid, sloan_id, coi_shown) %>%
...
# set up empty dataframe with the right column names
downloads_df = pd.DataFrame(columns=['guid', 'sloan_id', 'coi_shown', 'date', 'download_count'])
empty_lists = 0
calls = 1
      ...
      for x in range(len(pp_downloads_byuser)):
        ...
        for j in range(len(user_actions['buckets'])):
          ...
          for k in range(len(user_downloads)):
            ...
            # append new row with info for the preprint, the user, the timestamp, and the action count
            new_row = [{'guid':guid,'sloan_id':pp_downloads_byuser[x]['key'],'coi_shown':sloan_coi_cond,'date':user_downloads[k]['key_as_string'],'download_count': user_downloads[k]['doc_count']}]
...
# set up empty dataframe with the right column names
views_perminute_df = pd.DataFrame(columns=['guid', 'sloan_id', 'coi_shown', 'date', 'download_count'])
empty_lists = 0
calls = 1
      ...
      for x in range(len(pp_views_byuser_minutes )):
        ...
        for j in range(len(user_actions['buckets'])):
          ...
          for k in range(len(user_views)):
            ...
            # append new row with info for the preprint, the user, the timestamp, and the action count
            new_row = [{'guid':guid,'sloan_id':pp_views_byuser_minutes[x]['key'],'coi_shown':sloan_coi_cond,'date':user_views[k]['key_as_string'],'download_count': user_views[k]['doc_count']}]
...
# set up empty dataframe with the right column names
views_persecond_df = pd.DataFrame(columns=['guid', 'sloan_id', 'coi_shown', 'date', 'view_count'])
empty_lists = 0
calls = 1
      ...
      for x in range(len(pp_views_byuser_seconds )):
        ...
        for j in range(len(user_actions['buckets'])):
          ...
          for k in range(len(user_views)):
            ...
            # append new row with info for the preprint, the user, the timestamp, and the action count
            new_row = [{'guid':guid,'sloan_id':pp_views_byuser_seconds[x]['key'],'coi_shown':sloan_coi_cond,'date':user_views[k]['key_as_string'],'view_count': user_views[k]['doc_count']}]
...
# set up empty dataframe with the right column names
downloads_persecond_df = pd.DataFrame(columns=['guid', 'sloan_id', 'coi_shown', 'date', 'download_count'])
empty_lists = 0
calls = 1
      ...
      for x in range(len(pp_downloads_byuser_seconds )):
        ...
        for j in range(len(user_actions['buckets'])):
          ...
          for k in range(len(user_downloads)):
            ...
            # append new row with info for the preprint, the user, the timestamp, and the action count
            new_row = [{'guid':guid,'sloan_id':pp_downloads_byuser_seconds [x]['key'],'coi_shown':sloan_coi_cond,'date':user_downloads[k]['key_as_string'],'download_count': user_downloads[k]['doc_count']}]
      ...
      "aggs" : {
        "views_timeframe": {
            "filter": {
                "range" : {
                    "timestamp" : {
                        "gte" : "2020-04-21T20:37:53",
                        "lte" : "2020-05-26T20:37:53"
                    }
                }
            },
                    "aggs": {
...
# set up empty dataframe with the right column names
views_byhour_nosloanid = pd.DataFrame(columns=['guid', 'user_id', 'coi_shown', 'date', 'view_count'])
empty_lists = 0
calls = 1
      ...
      for x in range(len(pp_views_byuser_guid_byhour)):
        ...
        for j in range(len(user_actions['buckets'])):
          ...
          for k in range(len(user_views)):
            ...
            # append new row with info for the preprint, the user, the timestamp, and the action count
            new_row = [{'guid':guid,'user_id':pp_views_byuser_guid_byhour[x]['key'],'coi_shown':sloan_coi_cond,'date':user_views[k]['key_as_string'],'view_count': user_views[k]['doc_count']}]
...
views_bysecond_nosloanid_pull <- views_byhour_nosloanid %>%
                                    mutate(date = ymd_hms(date)) %>%
                                    filter(view_count > 0) %>%
                                    group_by(guid, user_id, coi_shown) %>%
                                    summarize(earliest_view = min(date)) %>%
                                    ungroup() %>%
                                    select(guid, earliest_view) %>% 
                                    distinct(.keep_all = T) %>%
...
# set up empty dataframe with the right column names
views_bysecond_nosloanid = pd.DataFrame(columns=['guid', 'user_id', 'coi_shown', 'date', 'view_count'])
empty_lists = 0
calls = 1
      ...
      for x in range(len(pp_views_byuser_guid_bysecond)):
        ...
        for j in range(len(user_actions['buckets'])):
          ...
          for k in range(len(user_views)):
            ...
            # append new row with info for the preprint, the user, the timestamp, and the action count
            new_row = [{'guid':guid,'user_id':pp_views_byuser_guid_bysecond[x]['key'],'coi_shown':sloan_coi_cond,'date':user_views[k]['key_as_string'],'view_count': user_views[k]['doc_count']}]
...
# set up empty dataframe with the right column names
downloads_byhour_nosloanid = pd.DataFrame(columns=['guid', 'user_id', 'coi_shown', 'date', 'download_count'])
empty_lists = 0
calls = 1
      ...
      for x in range(len(pp_downloads_byuser_guid_byhour)):
        ...
        for j in range(len(user_actions['buckets'])):
          ...
          for k in range(len(user_downloads)):
            ...
            # append new row with info for the preprint, the user, the timestamp, and the action count
            new_row = [{'guid':guid,'user_id':pp_downloads_byuser_guid_byhour[x]['key'],'coi_shown':sloan_coi_cond,'date':user_downloads[k]['key_as_string'],'download_count': user_downloads[k]['doc_count']}]
...
# set up empty dataframe with the right column names
downloads_bysecond_nosloanid = pd.DataFrame(columns=['guid', 'user_id', 'coi_shown', 'date', 'download_count'])
empty_lists = 0
calls = 1
      ...
      for x in range(len(pp_downloads_byuser_guid_bysecond)):
        ...
        for j in range(len(user_actions['buckets'])):
          ...
          for k in range(len(user_downloads)):
            ...
            # append new row with info for the preprint, the user, the timestamp, and the action count
            new_row = [{'guid':guid,'user_id':pp_downloads_byuser_guid_bysecond[x]['key'],'coi_shown':sloan_coi_cond,'date':user_downloads[k]['key_as_string'],'download_count': user_downloads[k]['doc_count']}]
